<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inicio-es-s.aspx.cs" Inherits="ProyectoJade.inicio_es_s" %>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                       ...
                       <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Caballero</a>
                            ...
                            <li><a class="dropdown-item" href="camisa-h-es-s.aspx">Camisas</a></li>
                    ...
                    <li class="nav-item dropdown">
                       <a class="nav-link dropdown-toggle"  id="navbarDropdown1" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Damas</a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="camisa-m-es-s.aspx">Camisas</a></li>
                                 <li><a class="dropdown-item" href="pantalones-m-es-s.aspx">Pantalones</a></li>
                    ...
                    <a class="btn btn-outline-dark" href="carrito.aspx">Carrito de Compras</a>
                            <section>
         <style type="text/css">
            a.gflag {
               font-size: -15px;
