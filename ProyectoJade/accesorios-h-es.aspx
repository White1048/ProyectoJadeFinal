<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="accesorios-h-es.aspx.cs" Inherits="ProyectoJade.accesorios_h_es" %>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="camisa-h-es.aspx">Camisa</a></li>
                         ...
                         <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="camisa-m-es.aspx">Camisa</a></li>
                   ...
                   <asp:Button ID="Button2"  runat="server" class="nav-link active" Text="Cerrar Sesion" OnClick="Button2_Click" />
              </div>
                        <section>
         <style type="text/css">
            a.gflag {
        ...
        <header class="bg-dark py-4">
            <div class="container px-4 px-lg-5 my-0">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Accesorios</h1>
