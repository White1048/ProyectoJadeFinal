<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="accesorios-m-es-s.aspx.cs" Inherits="ProyectoJade.accesorios_m_es_s" %>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                      ...
                      <a class="nav-link dropdown-toggle"  id="navbarDropdown2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Idioma</a>
                           ...
                           <li><a class="dropdown-item" href="accesorios-m-eng-s.aspx">English</a></li>
                               </ul>
                       </li>
                    </ul>
                    <form class="d-flex">
